...
[![Script](img/badge-script.svg)](markdown.md)
...
with several elements and then parses it using the [Markdown.Parse](./reference/fsharp-formatting-markdown-markdown.html#Parse) method:
...
transform and process the document. First of all the [MarkdownDocument.DefinedLinks](./reference/fsharp-formatting-markdown-markdowndocument.html#DefinedLinks) property
...
The document content can be accessed using the [MarkdownDocument.Paragraphs](./reference/fsharp-formatting-markdown-markdowndocument.html#Paragraphs) property that returns
...
paragraph, we can use active patterns from the [MarkdownPatterns](./reference/fsharp-formatting-markdown-markdownpatterns.html) module. These can be use
...
formatting (emphasis, strong) and also links. The `DirectLink` node from [MarkdownSpan](./reference/fsharp-formatting-markdown-markdownspan.html) represents an inline
...
Finally, the [Markdown](./reference/fsharp-formatting-markdown-markdown.html) type also includes a method [Markdown.ToHtml](./reference/fsharp-formatting-markdown-markdown.html#ToHtml) that can be used
