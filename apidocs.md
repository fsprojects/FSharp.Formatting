...
[![Script](img/badge-script.svg)](apidocs.md)
...
in the [ApiDocs](./reference/fsharp-formatting-apidocs-apidocs.html) type. To do this, load the assembly and open the necessary namespaces:
...
For example the [ApiDocs.GenerateHtml](./reference/fsharp-formatting-apidocs-apidocs.html#GenerateHtml) method:
