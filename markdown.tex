...
with several elements and then parses it using the \href{./reference/fsharp-formatting-markdown-markdown.html\#Parse}{Markdown.Parse} method:
\begin{lstlisting}[numbers=left]
...
transform and process the document. First of all the \href{./reference/fsharp-formatting-markdown-markdowndocument.html\#DefinedLinks}{MarkdownDocument.DefinedLinks} property
...
The document content can be accessed using the \href{./reference/fsharp-formatting-markdown-markdowndocument.html\#Paragraphs}{MarkdownDocument.Paragraphs} property that returns
...
paragraph, we can use active patterns from the \href{./reference/fsharp-formatting-markdown-markdownpatterns.html}{MarkdownPatterns} module. These can be use
...
formatting (emphasis, strong) and also links. The \texttt{DirectLink} node from \href{./reference/fsharp-formatting-markdown-markdownspan.html}{MarkdownSpan} represents an inline
...
Finally, the \href{./reference/fsharp-formatting-markdown-markdown.html}{Markdown} type also includes a method \href{./reference/fsharp-formatting-markdown-markdown.html\#ToHtml}{Markdown.ToHtml} that can be used
