...
[![Script](img/badge-script.svg)](codeformat.md)
...
Finally, the `CodeFormat` type also includes a method [CodeFormat.FormatHtml](./reference/fsharp-formatting-codeformat-codeformat.html#FormatHtml) that can be used
