...
[![Script](img/badge-script.svg)](literate.md)
...
as follows using functionality from the [Literate](./reference/fsharp-formatting-literate-literate.html) type:
...
The methods used above ([Literate.ConvertScriptFile](./reference/fsharp-formatting-literate-literate.html#ConvertScriptFile), [Literate.ConvertMarkdownFile](./reference/fsharp-formatting-literate-literate.html#ConvertMarkdownFile))
