...
[![Script](img/badge-script.svg)](evaluation.md)
...
[FsiEvaluator](./reference/fsharp-formatting-literate-evaluation-fsievaluator.html) that represents a wrapper for F# interactive and pass it to all the
...
The constructor of [FsiEvaluator](./reference/fsharp-formatting-literate-evaluation-fsievaluator.html) takes command line parameters for `fsi.exe` that can
...
This can be done by calling [FsiEvaluator.RegisterTransformation](./reference/fsharp-formatting-literate-evaluation-fsievaluator.html#RegisterTransformation) on the `FsiEvaluator` instance:
