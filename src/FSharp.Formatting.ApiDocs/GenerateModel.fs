...
module internal TypeFormatter =
    ...
    let formatCurriedArgsUsageAsHtml ctx preferNoParens isItemIndexer (curriedArgs: list<list<FSharpParameter>>) =
        let counter =
            let mutable n = 0
