...
[<assembly: AssemblyInformationalVersionAttribute("7.2.7")>]
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "7.2.7"
    let [<Literal>] AssemblyFileVersion = "7.2.7"
    let [<Literal>] AssemblyInformationalVersion = "7.2.7"
