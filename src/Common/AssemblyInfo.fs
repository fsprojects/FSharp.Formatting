...
[<assembly: AssemblyVersionAttribute("6.0.8")>]
[<assembly: AssemblyFileVersionAttribute("6.0.8")>]
[<assembly: AssemblyInformationalVersionAttribute("6.0.8")>]
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "6.0.8"
    let [<Literal>] AssemblyFileVersion = "6.0.8"
    let [<Literal>] AssemblyInformationalVersion = "6.0.8"
