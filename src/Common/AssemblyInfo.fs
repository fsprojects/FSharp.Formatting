...
[<assembly: AssemblyVersionAttribute("2.13.4")>]
[<assembly: AssemblyFileVersionAttribute("2.13.4")>]
[<assembly: AssemblyInformationalVersionAttribute("2.13.4")>]
[<assembly: AssemblyCopyrightAttribute("Apache 2.0 License")>]
do ()

module internal AssemblyVersionInformation =
    let [<Literal>] Version = "2.13.4"
