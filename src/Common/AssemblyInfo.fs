...
[<assembly: AssemblyVersionAttribute("7.1.5")>]
[<assembly: AssemblyFileVersionAttribute("7.1.5")>]
[<assembly: AssemblyInformationalVersionAttribute("7.1.5")>]
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "7.1.5"
    let [<Literal>] AssemblyFileVersion = "7.1.5"
    let [<Literal>] AssemblyInformationalVersion = "7.1.5"
