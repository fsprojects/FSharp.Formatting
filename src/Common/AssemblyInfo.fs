...
[<assembly: AssemblyInformationalVersionAttribute("7.1.1")>]
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "7.1.1"
    let [<Literal>] AssemblyFileVersion = "7.1.1"
    let [<Literal>] AssemblyInformationalVersion = "7.1.1"
