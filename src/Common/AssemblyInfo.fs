...
[<assembly: AssemblyVersionAttribute("2.13.2")>]
[<assembly: AssemblyFileVersionAttribute("2.13.2")>]
[<assembly: AssemblyInformationalVersionAttribute("2.13.2")>]
[<assembly: AssemblyCopyrightAttribute("Apache 2.0 License")>]
do ()

module internal AssemblyVersionInformation =
    let [<Literal>] Version = "2.13.2"
