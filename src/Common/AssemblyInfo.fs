...
[<assembly: AssemblyInformationalVersionAttribute("7.2.9")>]
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "7.2.9"
    let [<Literal>] AssemblyFileVersion = "7.2.9"
    let [<Literal>] AssemblyInformationalVersion = "7.2.9"
