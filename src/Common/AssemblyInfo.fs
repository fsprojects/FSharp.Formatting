...
[<assembly: AssemblyInformationalVersionAttribute("7.2.8")>]
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "7.2.8"
    let [<Literal>] AssemblyFileVersion = "7.2.8"
    let [<Literal>] AssemblyInformationalVersion = "7.2.8"
