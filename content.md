...
[![Script](img/badge-script.svg)](content.md)
...
* the text `` `cref:T:FSharp.Formatting.Markdown.MarkdownParagraph` `` resolves to the link [MarkdownParagraph](./reference/fsharp-formatting-markdown-markdownparagraph.html)
