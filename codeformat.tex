...
Finally, the \texttt{CodeFormat} type also includes a method \href{./reference/fsharp-formatting-codeformat-codeformat.html\#FormatHtml}{CodeFormat.FormatHtml} that can be used
