...
* Opt-in display of type constraints (e.g. `'T : equality`, `'T : comparison`, `'T :> IComparable`) in generated API documentation. When enabled, constraints are shown in a "Constraints:" line in the member tooltip alongside type parameters. Enable via `<FsDocsShowTypeConstraints>true</FsDocsShowTypeConstraints>` in the project file. [#591](https://github.com/fsprojects/FSharp.Formatting/issues/591)
